...
describe( 'stringIndices', () => {
  ...
  it('returns an empty string if the supplied index is greater than the length of the string.', () => {
    expect( stringIndices('It is such a lovely day.', -3)).to.equal( '' )
  })
  it('returns an empty string if the supplied index is less than the length of the string.', () => {
    expect( stringIndices('It is truly a lovely day.', 0)).to.equal( '' )
  })
